...
## Project Structure
    ...
    ├── testapiautosetting_123000  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123000`
...
2. Clone this repo and `cd testapiautosetting_123000`
